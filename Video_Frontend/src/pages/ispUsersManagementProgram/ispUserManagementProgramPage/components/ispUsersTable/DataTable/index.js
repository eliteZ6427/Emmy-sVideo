...
import ActionComponent from "pages/ispUsersManagementProgram/ispUserManagementProgramPage/components/ispUsersTable/ActionComponent";
    ...
    <TableContainer sx={{ boxShadow: "none" }}>
      ...
      <Grid item xs={12} sm={12}>
        <VuiBox ml="auto" mt="10px" sx={{textAlign:'center'}}>
          <VuiButton variant="outlined" sx={{ width: '95%' }} color="info" size="small" onClick={addHandleButtonChange}>
            Add New ISP
          </VuiButton>
        </VuiBox>
      </Grid>
...
DataTable.propTypes = {
  ...
  addHandleButtonChange: PropTypes.func
};
