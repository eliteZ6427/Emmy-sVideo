...
import { getAllClients, toogleSelectedClient } from "redux/actions/client";
...
function DataTable({
  ...
  const selectedRows = useSelector((state) => state.clientReducer.selectedClientsData);
  ...
  const handleRowSelect = (row) => {
    const selected_id = row.original.id
    dispatch(toogleSelectedClient(selected_id));
  };
